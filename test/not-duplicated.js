...
test(shouldDatabaseExist, 'meta', false)
...
test(shouldUserExist, 'UserA', false)
test(shouldUserExist, 'UserB', false)
test(shouldUserExist, 'UserC', true)
test(shouldUserExist, 'UserD', true)
